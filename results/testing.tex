...
For the processor core, Chisel test benches were used, as testing is quite well supported by the language itself. The processor core was also tested using VHDL test benches.
