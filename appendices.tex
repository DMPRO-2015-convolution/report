...
Schematic attachements follow:
\begin{enumerate}
    \item       Finished PCB
    \item       Xilinx Spartan-6 FPGA
    \item       Silicon Labs EFM32 MCU
    \item       RAM module
\end{enumerate}

\includepdf[landscape=true]{img/PCB_Finished.pdf}
\includepdf[landscape=true]{img/FPGA_Xilinx_Spartan6.pdf}
\includepdf[landscape=true]{img/MCU_EFM32.pdf}
\includepdf[landscape=true]{img/RAM_module.pdf}
