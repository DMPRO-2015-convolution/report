...
The MCU has 4 buttons for control. These are connected to PD8, PD7, PD6 and PD5. Se table [buttons] for info.
...
The EFM has spare pins that all are available on the P15 header pins. Pin 28 on P15 header is 3.3V VCC. The rest is pinouts from the EFM. Se table [header\_out] for location of pins.
\begin{table}[]
    \centering
