...
In order to achive this we had to parametrize our design, allowing us to generate different architectures by simply changing a parameter once.
...
\begin{description}
    ...
    \item[Data input width etc etc] \hfill \\
        Some words etc
\end{description}
