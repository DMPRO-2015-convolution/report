...
It was discovered that two of the address pins for the second memory chip had been exchanged, but we concluded this must be due to a swapping of the labels on the board, not the actual wires.
...
The image showed up on a connected display, thus we concluded the HDMI output was working.
