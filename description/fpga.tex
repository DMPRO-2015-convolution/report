...
\begin{description}
    \item[Conveyor] \hfill\\ 
        ...
        % Each row holds a sweep slice, which means every pixel register in a row has a one to one correspondance to one of the rows of the sweep currently feeding the core.
