...
As the assignment states, this should be done on a two-dimensional structure for which we have chosen an image.
...
\begin{table}[h]
    ...
    \begin{tabular}{lp{12cm}l}
        ...
        NFR2 &
            The processor should use a Silicon Labs EFM32 microcontroller as an I/O processor \\
        NFR3 &
