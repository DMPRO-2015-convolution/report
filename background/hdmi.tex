...
\begin{figure}[h]
    ...
    \caption[Resistance of electromagnetic noise by using differential signaling.]{Resistance of electromagnetic noise by using differential signaling. Credit to Wikipedia contributor Linear77.}
