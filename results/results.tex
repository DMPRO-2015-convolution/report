...
At other resolutions, this may not be as visible as horizontal synchronisation period is not a multiple of the time between each missing pixel from the processor.
