...
The highest correctly working resolution was found to be 1366x768. This worked in real time with no precieveable delay. We also tried 1600x900, and still got an image, but it was wrong. Finally, we tried 1920x1200, and got no output.

TODO: Because I wrote "we", this section will have to be rewritten. 
